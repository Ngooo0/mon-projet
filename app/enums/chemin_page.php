...
enum CheminPage: string
{
    ...
    case VIEW_AJOUTPROMO = __DIR__ . '/../views/promo/ajoutpromo.view.php';
    case VIEW_APPRENANT = __DIR__ . '/../views/promo/apprenant.view.php';
    case VIEW_AJOUTAPP = __DIR__ . '/../views/promo/ajoutapp.view.php';
    ...
    case CSS_AJOUTPROMO = '/assets/css/promo/ajoutpromo.css';
    case CSS_APPRENANT = '/assets/css/promo/apprenant.css';
    case CSS_AJOUTAPP = '/assets/css/promo/ajoutapp.css';
